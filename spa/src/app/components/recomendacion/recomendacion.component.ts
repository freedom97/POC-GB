...
export class RecomendacionComponent implements OnInit {
  ...
  ngOnInit() {
    Highcharts.chart('contenedor-actividad-financiera', {
        chart: {
            type: 'spline'
        },
        title: {
    ...
    // SEGUNDA GRÁFICA
    Highcharts.chart('contenedor-productos-por-banco', {
        chart: {
          type: 'column'
        },
        title: {
      ...
      // TERCERA GRAFICA
      Highcharts.chart('contenedor-ingresos-por-mes', {
        chart: {
            type: 'bar'
        },
        title: {
  ...
  // CUARTA GRÁFICA
    Highcharts.chart('contenedor-egresos-por-mes', {
        chart: {
            type: 'bar'
        },
        title: {
